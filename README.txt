...
**v1.4.2 (April 29, 2026)** — Shared connector-security extraction patch. Records-AI now consumes civiccore v0.12.0 for connector host validation and encrypted-config primitives instead of carrying private copies of those helpers. API URL paths, roles, permissions, and records-side database migrations are unchanged from v1.4.1.
